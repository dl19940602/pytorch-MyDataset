...
def default_loader(path):
    ...
    return Image.open(path).resize((256,256)).convert('RGB')
...
#    if args.dataset == 'cifar100':
    if args.dataset == 'taxiset':
        transform_train = transforms.Compose([transforms.RandomCrop(256),transforms.RandomHorizontalFlip(),transforms.ToTensor(),transforms.Normalize((0.4914, 0.4822, 0.4465),
                                 (0.2023, 0.1994, 0.2010)),])

        transform_test = transforms.Compose([transforms.ToTensor(),transforms.Normalize((0.4914, 0.4822, 0.4465),(0.2023, 0.1994, 0.2010)),])

        train_set = MyDataset(txt='/path/train_label.txt',transform=transform_train)

        test_set = MyDataset(txt='/path/test_label.txt',transform=transform_test)

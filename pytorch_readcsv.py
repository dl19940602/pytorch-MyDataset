...
def parse_args():
    ...
    parser.add_argument('--dataset', default='taxisetcsv',
...
#    if args.dataset == 'cifar100':
    if args.dataset == 'taxisetcsv':
        transform_train = transforms.Compose([transforms.RandomHorizontalFlip(),transforms.ToTensor(),transforms.Normalize((0.4914, 0.4822, 0.4465),
                                 (0.2023, 0.1994, 0.2010)),])

        transform_test = transforms.Compose([transforms.ToTensor(),transforms.Normalize((0.4914, 0.4822, 0.4465),(0.2023, 0.1994, 0.2010)),])

        train_set = MyDataset(csv='/path/train_label.csv',transform=transform_train)

        test_set = MyDataset(csv='/path/test_label.csv',transform=transform_test)
